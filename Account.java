...
public class Account {
    ...
    void deposit(int amount) {
        if (amount != 0) { //if amount is 0 we don t want to do any thing
            balance = balance + amount; // current balance
    ...
    void getPreviousTransaction() { //it does'nt Take any input
    ...
    void showMenu() {
        ...
        System.out.println("Thank you for using Studentbank!");
    }
